...
As with most machine learning models, the inputs and outputs of a neural network consist entirely of numeric vectors. Non-numeric input must therefore be vectorized into a numeric representation in a manner suitable for the network. As each neuron typically detects some useful feature based on its inputs, a good vector representation would follow this principle by being comprised of numeric elements, each signaling some independent and useful feature of the represented information.  
